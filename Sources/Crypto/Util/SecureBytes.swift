...
extension SecureBytes.Backing {
    ...
    @usableFromInline
    /* private but usableFromInline */ func _copyBytes<C: Collection>(_ bytes: C, at offset: Int) where C.Element == UInt8 {
...
extension SecureBytes.Backing: ContiguousBytes {
    ...
    @usableFromInline
    /* private but usableFromInline */ func _withVeryUnsafeMutableBytes<T>(_ body: (UnsafeMutableRawBufferPointer) throws -> T) rethrows -> T {
